...
const (
	Query_Account_FullMethodName           = "/zenanetwork.zena.vm.v1.Query/Account"
	Query_CosmosAccount_FullMethodName     = "/zenanetwork.zena.vm.v1.Query/CosmosAccount"
	Query_ValidatorAccount_FullMethodName  = "/zenanetwork.zena.vm.v1.Query/ValidatorAccount"
	Query_Balance_FullMethodName           = "/zenanetwork.zena.vm.v1.Query/Balance"
	Query_Storage_FullMethodName           = "/zenanetwork.zena.vm.v1.Query/Storage"
	Query_Code_FullMethodName              = "/zenanetwork.zena.vm.v1.Query/Code"
	Query_Params_FullMethodName            = "/zenanetwork.zena.vm.v1.Query/Params"
	Query_EthCall_FullMethodName           = "/zenanetwork.zena.vm.v1.Query/EthCall"
	Query_EstimateGas_FullMethodName       = "/zenanetwork.zena.vm.v1.Query/EstimateGas"
	Query_TraceTx_FullMethodName           = "/zenanetwork.zena.vm.v1.Query/TraceTx"
	Query_TraceBlock_FullMethodName        = "/zenanetwork.zena.vm.v1.Query/TraceBlock"
	Query_BaseFee_FullMethodName           = "/zenanetwork.zena.vm.v1.Query/BaseFee"
	Query_Config_FullMethodName            = "/zenanetwork.zena.vm.v1.Query/Config"
	Query_GlobalMinGasPrice_FullMethodName = "/zenanetwork.zena.vm.v1.Query/GlobalMinGasPrice"
)
