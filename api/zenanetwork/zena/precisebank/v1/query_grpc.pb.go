...
const (
	Query_Remainder_FullMethodName         = "/zenanetwork.zena.precisebank.v1.Query/Remainder"
	Query_FractionalBalance_FullMethodName = "/zenanetwork.zena.precisebank.v1.Query/FractionalBalance"
)
