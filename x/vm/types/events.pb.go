...
func (*EventEthereumTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_490bec5d1189b30f, []int{0}
}
...
func (*EventTxLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_490bec5d1189b30f, []int{1}
}
...
func (*EventMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_490bec5d1189b30f, []int{2}
}
...
func (*EventBlockBloom) Descriptor() ([]byte, []int) {
	return fileDescriptor_490bec5d1189b30f, []int{3}
}
...
func init() {
	proto.RegisterType((*EventEthereumTx)(nil), "zenanetwork.zena.vm.v1.EventEthereumTx")
	proto.RegisterType((*EventTxLog)(nil), "zenanetwork.zena.vm.v1.EventTxLog")
	proto.RegisterType((*EventMessage)(nil), "zenanetwork.zena.vm.v1.EventMessage")
	proto.RegisterType((*EventBlockBloom)(nil), "zenanetwork.zena.vm.v1.EventBlockBloom")
}

func init() {
	proto.RegisterFile("zenanetwork/zena/vm/v1/events.proto", fileDescriptor_490bec5d1189b30f)
}

var fileDescriptor_490bec5d1189b30f = []byte{
	// 367 bytes of a gzipped FileDescriptorProto
	,
}
