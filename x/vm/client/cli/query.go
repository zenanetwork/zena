...
func HexToBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "zenad query evm 0x-to-bech32 0x7cB61D4117AE31a12E393a1Cfa3BaC666481D02E",
		Args:    cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
...
func Bech32ToHexCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "zenad query evm bech32-to-0x cosmos10jmp6sgh4cc6zt3e8gw05wavvejgr5pwsjskvv",
		Args:    cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
...
func GetBankBalanceCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "zenad query evm balance-bank 0xA2A8B87390F8F2D188242656BFb6852914073D06 atoken",
		Args:    cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
func GetERC20BalanceCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "zenad query evm balance-erc20 0xA2A8B87390F8F2D188242656BFb6852914073D06 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE",
		Args:    cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
