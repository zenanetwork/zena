...
import (
	...
	"github.com/zenanetwork/zena/x/precisebank/testutil"
...
func TestGenesisStateValidate_Basic(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"invalid balances: duplicate address zenanet1qymahrl9",
		},
		{
			...
			"invalid balances: invalid fractional balance for zenanet1qg2r3fwz: non-positive amount -1",
		},
		{
		...
		},
		{
			...
			"remainder 1000000 exceeds max of 999999",
		},
	}
...
func TestGenesisStateValidate_Total(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"+ remainder 0 is not a multiple of 1000000",
		},
		{
			...
			"sum of fractional balances 0 + remainder 1 is not a multiple of 1000000",
		},
	}
