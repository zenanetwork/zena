...
const (
	denom         = "stake"
	validatorAddr = "zenanetvaloper1qypqxpq9qcrsszg2pvxq6rs0zqg3yyc5a3kaax"
)
...
func TestNewMsgRedelegate(t *testing.T) {
	...
	delegatorAddr := common.HexToAddress("0x1234567890123456789012345678901234567890")
	validatorSrcAddr := "zenanetvaloper1qypqxpq9qcrsszg2pvxq6rs0zqg3yyc5a3kaax"
	validatorDstAddr := "zenanetvaloper1qypqxpq9qcrsszg2pvxq6rs0zqg3yyc5a3kaay"
	amount := big.NewInt(1000000000)
