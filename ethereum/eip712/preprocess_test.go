...
var (
	...
	feePayerAddress = fmt.Sprintf(
		"%s17xpfvakm2amg962yls6f84z3kell8c5lc0y90c",
		constants.ExampleBech32Prefix,
	)
)

// getTestContext creates a properly configured client context with the correct bech32 prefix
func getTestContext() client.Context {
	// Must be called after sdk.GetConfig().SetBech32PrefixForAccount()
...
func createPopulatedTestCase(t *testing.T) TestCaseStruct {
	...
	msgSend := banktypes.MsgSend{
		...
		ToAddress:   "zenanet12luku6uxehhak02py4rcz65zu0swh7wj0tnuh6",
		Amount: sdk.NewCoins(
			sdk.NewCoin(
				evmtypes.GetEVMCoinDenom(),
