...
describe('Slashing – query methods', function () {
    ...
    const CONS_ADDR = getAddress('0x2E1CA93285D58942BA2E22FD893CCAC7C924C3A1') // address derived from ed25519 pubkey which is placed in ~/.zenad/config/priv_validator_key.json
    let slashing;
