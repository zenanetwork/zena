	...
	testCases := []struct {
	...
	}{
		{
			...
			verifyFunc: func(iterator mempool.Iterator) {
				...
				feeTx := tx2.(sdk.FeeTx)
				cosmosGasPrice := s.calculateCosmosGasPrice(feeTx.GetFee().AmountOf("aznnt").BigInt().Int64(), feeTx.GetGas())
		...
		},
		{
			...
			verifyFunc: func(iterator mempool.Iterator) {
				...
				feeTx := tx1.(sdk.FeeTx)
				actualGasPrice := s.calculateCosmosGasPrice(feeTx.GetFee().AmountOf("aznnt").Int64(), feeTx.GetGas())
		...
		},
		{
			...
			verifyFunc: func(iterator mempool.Iterator) {
				...
				feeTx := tx2.(sdk.FeeTx)
				effectiveTip = s.calculateCosmosEffectiveTip(feeTx.GetFee().AmountOf("aznnt").Int64(), feeTx.GetGas(), big.NewInt(0)) // base fee = 0
		...
		},
		{
			...
			verifyFunc: func(iterator mempool.Iterator) {
				...
				feeTx := tx2.(sdk.FeeTx)
				effectiveTip2 := s.calculateCosmosEffectiveTip(feeTx.GetFee().AmountOf("aznnt").Int64(), feeTx.GetGas(), big.NewInt(0)) // base fee = 0
		...
		},
		{
			...
			verifyFunc: func(iterator mempool.Iterator) {
				...
				cosmosGasPrice2 := s.calculateCosmosGasPrice(feeTx2.GetFee().AmountOf("aznnt").Int64(), feeTx2.GetGas())
				...
				cosmosGasPrice4 := s.calculateCosmosGasPrice(feeTx4.GetFee().AmountOf("aznnt").Int64(), feeTx4.GetGas())
				...
				cosmosGasPrice6 := s.calculateCosmosGasPrice(feeTx6.GetFee().AmountOf("aznnt").Int64(), feeTx6.GetGas())
