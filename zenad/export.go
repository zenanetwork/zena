...
// file.
func (app *ZENAD) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs []string, modulesToExport []string) (servertypes.ExportedApp, error) {
...
func (app *ZENAD) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) error {
