...
import (
	...
	cosmosevmhd "github.com/zenanetwork/zena/crypto/hd"
	...
	customnetwork "github.com/zenanetwork/zena/zenad/tests/network"
	evmnetwork "github.com/zenanetwork/zena/testutil/integration/evm/network"
...
Example:
	zenad testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "zenad", "Home directory of the node's daemon configuration")
...
Example:
	zenad testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
...
// NewTestNetworkFixture returns a new zenad AppConstructor for network simulation tests
