...
import (
	...
	evmencoding "github.com/zenanetwork/zena/encoding"
	evmaddress "github.com/zenanetwork/zena/encoding/address"
	evmmempool "github.com/zenanetwork/zena/mempool"
	precompiletypes "github.com/zenanetwork/zena/precompiles/types"
	...
	erc20v2 "github.com/zenanetwork/zena/x/erc20/v2"
	...
	cosmosevmserver "github.com/zenanetwork/zena/server"
)
...
var (
	_ runtime.AppI                = (*ZENAD)(nil)
	_ cosmosevmserver.Application = (*ZENAD)(nil)
	_ ibctesting.TestingApp       = (*ZENAD)(nil)
)

// ZENAD extends an ABCI application, but with most of its parameters exported.
type ZENAD struct {
	*baseapp.BaseApp
...
func (app *ZENAD) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
...
func (app *ZENAD) onPendingTx(hash common.Hash) {
...
func (app *ZENAD) RegisterPendingTxListener(listener func(common.Hash)) {
	app.pendingTxListeners = append(app.pendingTxListeners, listener)
}

func (app *ZENAD) setPostHandler() {
...
func (app *ZENAD) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *ZENAD) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *ZENAD) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *ZENAD) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	return app.BaseApp.FinalizeBlock(req)
}

func (app *ZENAD) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer application update at chain initialization
func (app *ZENAD) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *ZENAD) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// LoadHeight loads a particular height
func (app *ZENAD) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// LegacyAmino returns ZENAD's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *ZENAD) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns ZENAD's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *ZENAD) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns ZENAD's InterfaceRegistry
func (app *ZENAD) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns ZENAD's TxConfig
func (app *ZENAD) TxConfig() client.TxConfig {
	return app.txConfig
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (app *ZENAD) DefaultGenesis() map[string]json.RawMessage {
...
func (app *ZENAD) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *ZENAD) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *ZENAD) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
	return app.memKeys[storeKey]
}

// SimulationManager implements the SimulationApp interface
func (app *ZENAD) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *ZENAD) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *ZENAD) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *ZENAD) RegisterTendermintService(clientCtx client.Context) {
...
func (app *ZENAD) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *ZENAD) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *ZENAD) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return *app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *ZENAD) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

func (app *ZENAD) GetEVMKeeper() *evmkeeper.Keeper {
	return app.EVMKeeper
}

func (app *ZENAD) GetErc20Keeper() *erc20keeper.Keeper {
	return &app.Erc20Keeper
}

func (app *ZENAD) SetErc20Keeper(erc20Keeper erc20keeper.Keeper) {
	app.Erc20Keeper = erc20Keeper
}

func (app *ZENAD) GetGovKeeper() govkeeper.Keeper {
	return app.GovKeeper
}

func (app *ZENAD) GetEvidenceKeeper() *evidencekeeper.Keeper {
	return &app.EvidenceKeeper
}

func (app *ZENAD) GetSlashingKeeper() slashingkeeper.Keeper {
	return app.SlashingKeeper
}

func (app *ZENAD) GetBankKeeper() bankkeeper.Keeper {
	return app.BankKeeper
}

func (app *ZENAD) GetFeeMarketKeeper() *feemarketkeeper.Keeper {
	return &app.FeeMarketKeeper
}

func (app *ZENAD) GetFeeGrantKeeper() feegrantkeeper.Keeper {
	return app.FeeGrantKeeper
}

func (app *ZENAD) GetConsensusParamsKeeper() consensusparamkeeper.Keeper {
	return app.ConsensusParamsKeeper
}

func (app *ZENAD) GetAccountKeeper() authkeeper.AccountKeeper {
	return app.AccountKeeper
}

func (app *ZENAD) GetAuthzKeeper() authzkeeper.Keeper {
	return app.AuthzKeeper
}

func (app *ZENAD) GetDistrKeeper() distrkeeper.Keeper {
	return app.DistrKeeper
}

func (app *ZENAD) GetStakingKeeper() *stakingkeeper.Keeper {
	return app.StakingKeeper
}

func (app *ZENAD) GetMintKeeper() mintkeeper.Keeper {
	return app.MintKeeper
}

func (app *ZENAD) GetPreciseBankKeeper() *precisebankkeeper.Keeper {
	return &app.PreciseBankKeeper
}

func (app *ZENAD) GetCallbackKeeper() ibccallbackskeeper.ContractKeeper {
	return app.CallbackKeeper
}

func (app *ZENAD) GetTransferKeeper() transferkeeper.Keeper {
	return app.TransferKeeper
}

func (app *ZENAD) SetTransferKeeper(transferKeeper transferkeeper.Keeper) {
	app.TransferKeeper = transferKeeper
}

func (app *ZENAD) GetMempool() sdkmempool.ExtMempool {
	return app.EVMMempool
}

func (app *ZENAD) GetAnteHandler() sdk.AnteHandler {
	return app.BaseApp.AnteHandler()
}

// GetTxConfig implements the TestingApp interface.
func (app *ZENAD) GetTxConfig() client.TxConfig {
	return app.txConfig
}

func (app *ZENAD) SetClientCtx(clientCtx client.Context) { // TODO:VLAD - Remove this if possible
...
func (app *ZENAD) AutoCliOpts() autocli.AppOptions {
