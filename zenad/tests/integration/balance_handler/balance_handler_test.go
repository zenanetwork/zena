...
import (
	...
	debugprecompile "github.com/zenanetwork/zena/zenad/tests/testdata/debug"
...
func (s *BalanceHandlerTestSuite) TestRecursivePrecompileCallsWithDebugPrecompile() {
	...
	// Fund Contract
	err = evmApp.GetBankKeeper().SendCoins(ctx, s.chain.SenderAccounts[0].SenderAccount.GetAddress(), callerAddr.Bytes(), types.NewCoins(types.NewCoin("aznnt", sdkmath.NewInt(10000000))))
	s.Require().NoError(err)
