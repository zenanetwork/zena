...
import (
	...
	clientkeys "github.com/zenanetwork/zena/client/keys"
	...
	"github.com/zenanetwork/zena/zenad/tests/ledger/mocks"
...
func (suite *LedgerTestSuite) SetupEvmosApp() {
	...
	suite.app = zenad.Setup(suite.T(), chainID.ChainID, chainID.EVMChainID)
