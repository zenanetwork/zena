...
import (
	...
	evmtestutil "github.com/zenanetwork/zena/testutil"
...
func DefaultConfig() Config {
	...
	tempApp := zenad.NewExampleApp(log.NewNopLogger(), dbm.NewMemDB(), nil, true, simutils.NewAppOptionsWithFlagHome(dir), baseapp.SetChainID(chainID))
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		clientDir := filepath.Join(network.BaseDir, nodeDirName, "zenacli")
