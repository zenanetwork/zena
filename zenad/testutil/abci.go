...
//  3. EndBlock
//  4. Commit
func Commit(ctx sdk.Context, app zena.EvmApp, t time.Duration, vs *cmttypes.ValidatorSet) (sdk.Context, error) {
...
func CommitAndCreateNewCtx(ctx sdk.Context, app zena.EvmApp, t time.Duration, vs *cmttypes.ValidatorSet) (sdk.Context, error) {
	header, err := commit(ctx, app, t, vs)
	if err != nil {
		return ctx, err
	}
...
func commit(ctx sdk.Context, app zena.EvmApp, t time.Duration, vs *cmttypes.ValidatorSet) (tmproto.Header, error) {
...
func checkTxBytes(app zena.EvmApp, txEncoder sdk.TxEncoder, tx sdk.Tx) (abci.ResponseCheckTx, error) {
	bz, err := txEncoder(tx)
	if err != nil {
		return abci.ResponseCheckTx{}, err
	}
