...
```diff
- govPrecompile, err := govprecompile.NewPrecompile // from govprecompile "github.com/zenanetwork/zena/precompiles/gov"(govKeeper, cdc)
+ govPrecompile, err := govprecompile.NewPrecompile // from govprecompile "github.com/zenanetwork/zena/precompiles/gov"(govKeeper, cdc, options.AddressCodec)
```
