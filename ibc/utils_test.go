...
func init() {
	cfg := sdk.GetConfig()
	cfg.SetBech32PrefixForAccount("zenanet", "zenanetpub")
}
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "cosmos1",
				Receiver: "zenanet1x2w87cvt5mqjncav4lxy8yfreynn273xer862p",
				Amount:   "123456",
			},
			expSender:    "",
			expRecipient: "",
		...
		},
		{
			...
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "zenanet1qql8ag4cluz6r4dz28p3w00dnc9w8ueuh7ddla",
				Receiver: "cosmos1",
				Amount:   "123456",
			},
			expSender:    "",
		...
		},
		{
			...
			expSender:    "zenanet1qql8ag4cluz6r4dz28p3w00dnc9w8ueuh7ddla",
			expRecipient: "zenanet1x2w87cvt5mqjncav4lxy8yfreynn273xer862p",
			expError:     false,
		},
		{
			...
			data: transfertypes.FungibleTokenPacketData{
				...
				Receiver: "zenanet1qql8ag4cluz6r4dz28p3w00dnc9w8ueuh7ddla",
				Amount:   "123456",
			},
			expSender:    "zenanet1x2w87cvt5mqjncav4lxy8yfreynn273xer862p",
			expRecipient: "zenanet1qql8ag4cluz6r4dz28p3w00dnc9w8ueuh7ddla",
			expError:     false,
		},
		{
...
func TestGetReceivedCoin(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			rawAmount: "10",
			expCoin: func() sdk.Coin {
				expectedDenom := transfertypes.NewDenom("uznnt").IBCDenom()
				return sdk.NewCoin(expectedDenom, math.NewInt(10))
			},
		},
		{
		...
		},
		{
			...
			dstChannel: chan0,
			rawDenom: func() string {
				denom := transfertypes.NewDenom("uznnt",
					transfertypes.NewHop(port, chan1),
				)
				return denom.Path()
			},
...
func TestGetSentCoin(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			"get ibc wrapped uznnt coin",
			"transfer/channel-1/uznnt",
			"10",
			sdk.Coin{Denom: precompilestestutil.UatomIbcDenom, Amount: math.NewInt(10)},
		},
		{
			"get 2x ibc wrapped uznnt coin",
			"transfer/channel-0/transfer/channel-1/uznnt",
			"10",
