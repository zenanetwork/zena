...
type CreateEvmApp func(chainID string, evmChainID uint64, customBaseAppOptions ...func(*baseapp.BaseApp)) zena.EvmApp
...
func (n *IntegrationNetwork) configureAndInitChain(evmApp zena.EvmApp) error {
	// --------------------------------------------------------------------------------------------
