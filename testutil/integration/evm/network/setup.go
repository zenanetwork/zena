...
type genSetupFn func(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, customGenesis interface{}) (cosmosevmtypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ zena.EvmApp, genesisState cosmosevmtypes.GenesisState, _ interface{}) (cosmosevmtypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, customGenesis interface{}) (cosmosevmtypes.GenesisState, error) {
...
func setDefaultStakingGenesisState(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, overwriteParams StakingCustomGenesisState) cosmosevmtypes.GenesisState {
	// Set staking params
...
func setDefaultBankGenesisState(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, overwriteParams BankCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setDefaultSlashingGenesisState(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, overwriteParams SlashingCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setBankGenesisState(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, customGenesis interface{}) (cosmosevmtypes.GenesisState, error) {
...
func setDefaultAuthGenesisState(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, genAccs []authtypes.GenesisAccount) cosmosevmtypes.GenesisState {
...
func setAuthGenesisState(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, customGenesis interface{}) (cosmosevmtypes.GenesisState, error) {
...
func setDefaultGovGenesisState(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, overwriteParams GovCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setDefaultFeeMarketGenesisState(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, overwriteParams FeeMarketCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setDefaultMintGenesisState(cosmosEVMApp zena.EvmApp, genesisState cosmosevmtypes.GenesisState, overwriteParams MintCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setDefaultErc20GenesisState(cosmosEVMApp zena.EvmApp, evmChainID uint64, genesisState cosmosevmtypes.GenesisState) cosmosevmtypes.GenesisState {
...
func newDefaultGenesisState(cosmosEVMApp zena.EvmApp, evmChainID uint64, params defaultGenesisParams) cosmosevmtypes.GenesisState {
...
func customizeGenesis(cosmosEVMApp zena.EvmApp, customGen CustomGenesisState, genesisState cosmosevmtypes.GenesisState) (cosmosevmtypes.GenesisState, error) {
	var err error
